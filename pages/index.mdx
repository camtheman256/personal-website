...
- i run with the [new york harriers](https://www.newyorkharriers.com/) and compete in [nyrr races](https://results.nyrr.org/runner/49949781/races)
...
- copenhagen, denmark where i interned at [klimate](https://klimate.co) through the [mit-denmark program](https://misti.mit.edu/mit-denmark)
